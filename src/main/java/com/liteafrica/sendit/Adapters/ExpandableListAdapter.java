...
import com.liteafrica.sendit.Activites.Canteen.GetSupplierDetails;
...
import com.liteafrica.sendit.Requests.OrderDashboard;
...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (album_pos.getDelivered(childPosition)==0) {
            ...
            _status.setText("ETA updated at "+parseDateToETR(album_pos.getTime(childPosition)));

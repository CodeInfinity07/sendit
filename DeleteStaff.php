 ...
 <aside id="left-panel" class="left-panel">
  ...
  <h3 class="menu-title">Extras</h3><!-- /.menu-title -->
   ...
   <div class="dropdown for-notification">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT `ID`, `FirstName`, `LastName`, `Role`,`StaffID`, `Email`, `Photo`, `PhoneNo`, `Password`, `loginDate`, `isAdmin`, `isStaff`, `isOffice`, `isVerified` FROM `admin_login_data` WHERE  `isAdmin`=0");
    ...
    <td><img src="<?php echo 'http://' . $server_ip .'/' .'Groom' .'/'.'Dashboard'.'/'.'staffpic'.'/'.$user["Photo"];?>" width='48' height='48'/></td>
                       <td><?php echo $user['StaffID']; ?></td>
<td><a href="delete_staff.php?id=<?php echo $user['ID']; ?>" style="display:block; color: red;" >Delete</a></td>
                    </tr>
                    <?php endforeach; else: ?>

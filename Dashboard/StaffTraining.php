                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Staff Training</li>
                        </ol>
                    </div>
                </div>
            </div>
                                              ...
                                              <div class="col-lg-6">
                                                 <div class="card">
                                                    <div class="card-header">
                                                        <strong>New Training Link</strong>
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form action="addTraining.php" method="post" enctype="multipart/form-data" target="_self" class="form-horizontal">

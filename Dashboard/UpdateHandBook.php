  ...
  <h3 class="menu-title">Extras</h3><!-- /.menu-title -->
   ...
   <div class="dropdown for-notification">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Update Handbook</li>
                        </ol>
                    </div>
                </div>
            </div>
                                              ...
                                              <div class="col-lg-6">
                                                 <div class="card">
                                                    <div class="card-header">
                                                        <strong>Update Handbook</strong>
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form id="form1" action="addHandbook.php" method="post" enctype="multipart/form-data" target="_self" class="form-horizontal">
        ...
        echo "Could not connect to DBMS"; 
         }else {  $sql =$conn->query("SELECT  ID,`Title` FROM `handbooks` WHERE isActive=1");
        foreach($sql as $row) {
    ?>
...
?>
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT `ID`, `Title`, `Details`, `Links` FROM `handbooks` WHERE isActive=1 ");
...
var id='id='+ value;
 ...
 xmlhttp.open("POST","getDataHandbook.php",true);

  ...
  <h3 class="menu-title">Extras</h3><!-- /.menu-title -->
   ...
   <div class="dropdown for-notification">
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                                              ...
                                              <div class="col-lg-6">
                                                 <div class="card">
                                                    <div class="card-header">
                                                        <strong>Update Training</strong>
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form id="form1" action="addTraining.php" method="post" enctype="multipart/form-data" target="_self" class="form-horizontal">
                            ...
                            <div class="col-9 col-md-9"><select form="form1" id="id" name="id"  class="input-sm form-control-sm form-control"   required onchange ="getAddress(this.value)">
                             <datalist id="m8-datalist" ></datalist> 
        ...
        echo "Could not connect to DBMS"; 
         }else {  $sql =$conn->query("SELECT  ID,`Title` FROM `training` WHERE isActive=1");
        foreach($sql as $row) {
    ?>
...
?>
                        ...
                        <div class="card" >
                            <div class="card-header">
                                <strong class="card-title">Existing Training Links</strong>
                            </div>
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT `ID`, `Title`, `Details`, `Links` FROM `training` WHERE isActive=1 ");
                    ...
                    <tr>
                        ...
                        <td><a href="TrainingDeleteLink.php?id=<?php echo $user['ID']; ?>" style="color: red;"><?php echo "DEL"; ?></td>
...
var id='id='+ value;
 ...
 xmlhttp.open("POST","getDataTraining.php",true);

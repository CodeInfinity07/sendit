...
In case you need to adjust the built-in validation regular ion patterns, please [follow the documentation](http://jqueryvalidation.org/jQuery.validator.methods/).

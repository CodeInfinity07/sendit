...
The placeholder is a jQuery object or DOM element or jQuery ion
...
legend: {
    ...
    container: null or jQuery object/DOM element/jQuery ion
...
specify "container" as a jQuery object/ion to put the legend
...
The size and lineHeight must be ed in pixels; CSS units such as 'em'

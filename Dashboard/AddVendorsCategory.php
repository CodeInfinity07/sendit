                                              ...
                                              <div class="col-lg-12">
                                                 <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                          <form action="addvendorCategory.php" method="post" enctype="multipart/form-data" target="_self"  class="form-horizontal">
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT `ID`, `Category`, `Photo`, `Date`, `Time` FROM `CanteenCategory`");

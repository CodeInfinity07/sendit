                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT o.AdminAccepted,o.ID, o.StaffID ,a.FirstName,a.LastName,r.Reason, o.FromDate, o.FromTime, o.ToDate, o.ToTime, o.Message, o.Accepted FROM `leave_request` o INNER JOIN admin_login_data a ON a.ID=o.StaffID INNER JOIN  leave_reason r ON r.ID=o.Reason ");
                    ...
                    <tr>
                        ...
                        <td ><?php echo $user['FirstName'].$user["LastName"]; ?></a></td>

 ...
 <aside id="left-panel" class="left-panel">
  ...
  <h3 class="menu-title">PushNotification</h3>
                     ...
                     <li class="menu-item-has-children dropdown">
                      ...
                      <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-list"></i>Produts</a>
                        <ul class="sub-menu children dropdown-menu">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Select Seller to upload product</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                ...
                <div class="row">
                      ...
                      $conn = $db->connect();
                        $date=date("Y-m-d");
                         $server_ip="139.59.38.160";
                          ...
                          $users =$conn->query("SELECT `ID`, `Category`, `Name`, `Phone_No`, `Email`, `Aboutus`, `Address`, `State`, `City`, `Pin_No`, `Latitude`, `Longitude`, `Photo`, `Open_time`, `Close_time`, `Minimum_orders`, `Minimum_time`, `Discount`, `Rating`, `TotalRating`, `Popular`, `isActive`, `Date`, `Time`,(SELECT Category FROM CanteenCategory WHERE ID=s.Category) AS `mCategory` FROM `tez_Canteen` s WHERE Category>0");
                    ...
                    <tr>
                        ...
                        <td><?php echo $user['Name']; ?></td>
                         <td style="color: red;"><?php echo $user['mCategory']; ?></td>
                        ...
                        <td><?php echo $user['Discount']; ?></td>
                         <td><a href="AddFinalService.php?id=<?php echo $user['ID']; ?>&Category=<?php echo $user['Category']; ?>" style="display:block;color: blue;"><u>Select</u></a></td>
                    </tr>
                    <?php endforeach; else: ?>

            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                                              ...
                                              <div class="col-lg-6">
                                                 <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="addHealth.php" method="post" enctype="multipart/form-data" target="_self" class="form-horizontal">
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT `ID`, `Title`, `Details`, `Links` FROM `health` WHERE isActive=1 ");
                    ...
                    <tr>
                        ...
                        <td><a href="HealthDeleteLink.php?id=<?php echo $user['ID']; ?>" style="color: red;"><?php echo "DEL"; ?></td>

                    ...
                    <div class="col-md-12">
                        <div class="card" >
                         <div class="card-header">
                                <strong class="card-title">Request Leave</strong>
                            </div>
                            <div class="card-body" >
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT o.AdminAccepted,o.ID, a.ID AS UserID,a.FirstName,a.LastName,r.Reason, o.FromDate, o.FromTime, o.ToDate, o.ToTime, o.Message, o.Accepted FROM `leave_request` o INNER JOIN admin_login_data a ON a.ID=o.StaffID INNER JOIN  leave_reason r ON r.ID=o.Reason ");
...
function changedata(UserID,id,value) {
 ...
 var id='id='+ id+'&value='+value+'&where=3';
...
request.onreadystatechange = function(response) {
  if (request.readyState === 4) {
    if (request.status === 200) {
          ...
          window.location.replace('http://139.59.38.160/Ecosense/Dashboard/notifyRequest.php?id='+UserID+'&msg=Please check update on your Leave reuest');

                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT w.ID,(SELECT Name FROM new_site WHERE ID=w.SiteID) AS SiteID, (SELECT FirstName FROM admin_login_data WHERE ID=c.StaffID) AS StaffID, c.clockinTime FROM `clockout` c  INNER JOIN workingsites w ON w.ID=c.WorkingID  WHERE c.clockinTime!='00:00:00' AND c.clockoutTime='00:00:00'");

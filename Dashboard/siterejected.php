                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT w.Name, w.ContactName, w.ContactNo,(SELECT FirstName FROM admin_login_data WHERE ID=w.StaffID) AS StaffID,(SELECT LastName FROM admin_login_data WHERE ID=w.StaffID) AS LastName,w.Latitude, w.Longitude, `Accepted`, `isActive` FROM `workingsites` w  INNER JOIN clockout c ON c.SiteID!=w.ID  WHERE  Accepted=1  ");

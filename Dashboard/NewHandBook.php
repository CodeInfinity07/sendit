                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">New Handbook</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                                              ...
                                              <div class="col-lg-6">
                                                 <div class="card">
                                                    <div class="card-header">
                                                        <strong>New Handbook</strong>
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form action="addHandbook.php" method="post" enctype="multipart/form-data" target="_self" class="form-horizontal">
                    ...
                    <tr>
                        ...
                        <td><a href="HandBookDeleteLink.php?id=<?php echo $user['ID']; ?>" style="color: red;"><?php echo "DEL"; ?></td>

...
<body onload="myFunction()">
                    ...
                    <div class="col-md-12">
                        <div class="card" >
                         <div class="card-header">
                                <strong class="card-title">Unemployment</strong>
                            </div>
                            <div class="card-body" >
 ...
 $server_ip="139.59.38.160";
                               ...
                               $users =$conn->query("SELECT `ID`,(SELECT Name From user_details WHERE ID=v.UserID) AS `IDSender`,title,description, `Videos`, `Date`, `Time` FROM `videos` v");
                    ...
                    <tr>
                      ...
                      <td><?php echo $user['IDSender']; ?></td>
                         <td><?php echo $user['title']; ?></td>
                        <td><?php echo $user['description']; ?></td>
                         
                                            <td> <iframe width="320" height="240" src="<?php echo 'http://' . $server_ip .'/' .'FashClub' .'/'.'video'.'/'.$user["Videos"];?>" frameborder="0" allowfullscreen></iframe>

      </iframe></td>
       
        <td><a href="<?php echo 'http://' . $server_ip .'/' .'FashClub' .'/'.'video'.'/'.$user["Videos"];?>"  download style="display:block; width: 60px;">Download</a></td>

                                              ...
                                              <div class="col-lg-12">
                                                 <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                                    ...
                                                                    <div class="col col-md-3"><label for="select" class=" form-control-label">Category of the Vendor</label></div>
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT `ID`,(SELECT `Category` FROM `CanteenCategory` c WHERE ID=m.Category) AS Category, `Name`, `isActive`, `User`, `Date`, `Time` FROM `menu_type` m  WHERE `isActive`=1");

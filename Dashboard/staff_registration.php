  ...
  <h3 class="menu-title">Extras</h3><!-- /.menu-title -->
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                             ...
                             <div class="col col-md-3"><label for="text-input" class=" input-sm form-control-sm form-control-label">Working Site</label></div>
                              <div class="col-8 col-md-8"><input type="text" id="WorkingSite" name="WorkingSite"  class="input-sm form-control-sm form-control" ></div>
   ...
   <option value="0">--Select--</option>
        ...
        echo "Could not connect to DBMS"; 
         }else {  $sql =$conn->query("SELECT `ID`, `Role` FROM `jobrole` WHERE ID>1 ");
        foreach($sql as $row) {
    ?>

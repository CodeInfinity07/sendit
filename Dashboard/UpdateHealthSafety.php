                                              ...
                                              <div class="col-lg-6">
                                                 <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form id="form1" action="addHealth.php" method="post" enctype="multipart/form-data" target="_self" class="form-horizontal">
...
request.open('POST', 'getHealth.php', true);
...
var id='id='+ value;
 ...
 xmlhttp.open("POST","getDataHealth.php",true);

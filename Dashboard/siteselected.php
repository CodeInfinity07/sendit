                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      $conn = $db->connect();
                       ...
                       $users =$conn->query("SELECT c.Name, c.ContactName, c.ContactNo,(SELECT FirstName FROM admin_login_data WHERE ID=w.StaffID) AS StaffID,(SELECT LastName FROM admin_login_data WHERE ID=w.StaffID) AS LastName,c.Latitude, c.Longitude FROM `workingsites` w  INNER JOIN new_site c ON w.SiteID!=c.ID  WHERE  Accepted=2 ");
